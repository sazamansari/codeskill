...
declare const ListReceiptRuleSetsCommand_base: {
    new (input: ListReceiptRuleSetsCommandInput): import("@smithy/core/client").CommandImpl<ListReceiptRuleSetsCommandInput, ListReceiptRuleSetsCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListReceiptRuleSetsCommandInput]): import("@smithy/core/client").CommandImpl<ListReceiptRuleSetsCommandInput, ListReceiptRuleSetsCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
