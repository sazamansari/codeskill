...
declare const GetCustomVerificationEmailTemplateCommand_base: {
    new (input: GetCustomVerificationEmailTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetCustomVerificationEmailTemplateCommandInput, GetCustomVerificationEmailTemplateCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCustomVerificationEmailTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetCustomVerificationEmailTemplateCommandInput, GetCustomVerificationEmailTemplateCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
