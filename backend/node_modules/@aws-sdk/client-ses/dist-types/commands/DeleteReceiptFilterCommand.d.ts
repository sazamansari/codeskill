...
declare const DeleteReceiptFilterCommand_base: {
    new (input: DeleteReceiptFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteReceiptFilterCommandInput, DeleteReceiptFilterCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteReceiptFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteReceiptFilterCommandInput, DeleteReceiptFilterCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
