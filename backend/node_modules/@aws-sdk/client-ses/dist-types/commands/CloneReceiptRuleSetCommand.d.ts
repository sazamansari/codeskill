...
declare const CloneReceiptRuleSetCommand_base: {
    new (input: CloneReceiptRuleSetCommandInput): import("@smithy/core/client").CommandImpl<CloneReceiptRuleSetCommandInput, CloneReceiptRuleSetCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CloneReceiptRuleSetCommandInput): import("@smithy/core/client").CommandImpl<CloneReceiptRuleSetCommandInput, CloneReceiptRuleSetCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
