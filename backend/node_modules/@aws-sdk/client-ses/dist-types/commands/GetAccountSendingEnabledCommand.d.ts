...
declare const GetAccountSendingEnabledCommand_base: {
    new (input: GetAccountSendingEnabledCommandInput): import("@smithy/core/client").CommandImpl<GetAccountSendingEnabledCommandInput, GetAccountSendingEnabledCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetAccountSendingEnabledCommandInput]): import("@smithy/core/client").CommandImpl<GetAccountSendingEnabledCommandInput, GetAccountSendingEnabledCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
