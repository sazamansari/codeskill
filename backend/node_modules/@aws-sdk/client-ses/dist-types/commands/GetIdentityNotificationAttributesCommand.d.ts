...
declare const GetIdentityNotificationAttributesCommand_base: {
    new (input: GetIdentityNotificationAttributesCommandInput): import("@smithy/core/client").CommandImpl<GetIdentityNotificationAttributesCommandInput, GetIdentityNotificationAttributesCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIdentityNotificationAttributesCommandInput): import("@smithy/core/client").CommandImpl<GetIdentityNotificationAttributesCommandInput, GetIdentityNotificationAttributesCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
