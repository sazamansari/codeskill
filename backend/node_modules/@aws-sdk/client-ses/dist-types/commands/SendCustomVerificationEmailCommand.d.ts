...
declare const SendCustomVerificationEmailCommand_base: {
    new (input: SendCustomVerificationEmailCommandInput): import("@smithy/core/client").CommandImpl<SendCustomVerificationEmailCommandInput, SendCustomVerificationEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendCustomVerificationEmailCommandInput): import("@smithy/core/client").CommandImpl<SendCustomVerificationEmailCommandInput, SendCustomVerificationEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
