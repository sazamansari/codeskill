...
declare const DescribeReceiptRuleCommand_base: {
    new (input: DescribeReceiptRuleCommandInput): import("@smithy/core/client").CommandImpl<DescribeReceiptRuleCommandInput, DescribeReceiptRuleCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeReceiptRuleCommandInput): import("@smithy/core/client").CommandImpl<DescribeReceiptRuleCommandInput, DescribeReceiptRuleCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
