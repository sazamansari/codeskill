...
declare const GetIdentityDkimAttributesCommand_base: {
    new (input: GetIdentityDkimAttributesCommandInput): import("@smithy/core/client").CommandImpl<GetIdentityDkimAttributesCommandInput, GetIdentityDkimAttributesCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIdentityDkimAttributesCommandInput): import("@smithy/core/client").CommandImpl<GetIdentityDkimAttributesCommandInput, GetIdentityDkimAttributesCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
