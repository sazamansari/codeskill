...
declare const SendBulkTemplatedEmailCommand_base: {
    new (input: SendBulkTemplatedEmailCommandInput): import("@smithy/core/client").CommandImpl<SendBulkTemplatedEmailCommandInput, SendBulkTemplatedEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendBulkTemplatedEmailCommandInput): import("@smithy/core/client").CommandImpl<SendBulkTemplatedEmailCommandInput, SendBulkTemplatedEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
