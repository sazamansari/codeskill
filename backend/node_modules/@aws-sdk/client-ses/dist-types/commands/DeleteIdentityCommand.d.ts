...
declare const DeleteIdentityCommand_base: {
    new (input: DeleteIdentityCommandInput): import("@smithy/core/client").CommandImpl<DeleteIdentityCommandInput, DeleteIdentityCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIdentityCommandInput): import("@smithy/core/client").CommandImpl<DeleteIdentityCommandInput, DeleteIdentityCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
