...
declare const SendRawEmailCommand_base: {
    new (input: SendRawEmailCommandInput): import("@smithy/core/client").CommandImpl<SendRawEmailCommandInput, SendRawEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendRawEmailCommandInput): import("@smithy/core/client").CommandImpl<SendRawEmailCommandInput, SendRawEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
