...
declare const GetSendQuotaCommand_base: {
    new (input: GetSendQuotaCommandInput): import("@smithy/core/client").CommandImpl<GetSendQuotaCommandInput, GetSendQuotaCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetSendQuotaCommandInput]): import("@smithy/core/client").CommandImpl<GetSendQuotaCommandInput, GetSendQuotaCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
