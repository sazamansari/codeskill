...
declare const SetActiveReceiptRuleSetCommand_base: {
    new (input: SetActiveReceiptRuleSetCommandInput): import("@smithy/core/client").CommandImpl<SetActiveReceiptRuleSetCommandInput, SetActiveReceiptRuleSetCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [SetActiveReceiptRuleSetCommandInput]): import("@smithy/core/client").CommandImpl<SetActiveReceiptRuleSetCommandInput, SetActiveReceiptRuleSetCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
