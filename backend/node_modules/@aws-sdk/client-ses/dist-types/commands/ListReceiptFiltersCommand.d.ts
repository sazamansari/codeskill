...
declare const ListReceiptFiltersCommand_base: {
    new (input: ListReceiptFiltersCommandInput): import("@smithy/core/client").CommandImpl<ListReceiptFiltersCommandInput, ListReceiptFiltersCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListReceiptFiltersCommandInput]): import("@smithy/core/client").CommandImpl<ListReceiptFiltersCommandInput, ListReceiptFiltersCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
