...
declare const SendTemplatedEmailCommand_base: {
    new (input: SendTemplatedEmailCommandInput): import("@smithy/core/client").CommandImpl<SendTemplatedEmailCommandInput, SendTemplatedEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendTemplatedEmailCommandInput): import("@smithy/core/client").CommandImpl<SendTemplatedEmailCommandInput, SendTemplatedEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
