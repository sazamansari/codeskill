...
declare const CreateReceiptRuleSetCommand_base: {
    new (input: CreateReceiptRuleSetCommandInput): import("@smithy/core/client").CommandImpl<CreateReceiptRuleSetCommandInput, CreateReceiptRuleSetCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateReceiptRuleSetCommandInput): import("@smithy/core/client").CommandImpl<CreateReceiptRuleSetCommandInput, CreateReceiptRuleSetCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
