...
declare const PutIdentityPolicyCommand_base: {
    new (input: PutIdentityPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutIdentityPolicyCommandInput, PutIdentityPolicyCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutIdentityPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutIdentityPolicyCommandInput, PutIdentityPolicyCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
