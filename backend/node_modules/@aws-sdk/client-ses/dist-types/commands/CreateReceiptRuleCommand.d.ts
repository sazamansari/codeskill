...
declare const CreateReceiptRuleCommand_base: {
    new (input: CreateReceiptRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateReceiptRuleCommandInput, CreateReceiptRuleCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateReceiptRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateReceiptRuleCommandInput, CreateReceiptRuleCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
