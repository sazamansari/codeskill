...
declare const GetSendStatisticsCommand_base: {
    new (input: GetSendStatisticsCommandInput): import("@smithy/core/client").CommandImpl<GetSendStatisticsCommandInput, GetSendStatisticsCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetSendStatisticsCommandInput]): import("@smithy/core/client").CommandImpl<GetSendStatisticsCommandInput, GetSendStatisticsCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
