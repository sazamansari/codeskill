...
declare const CreateReceiptFilterCommand_base: {
    new (input: CreateReceiptFilterCommandInput): import("@smithy/core/client").CommandImpl<CreateReceiptFilterCommandInput, CreateReceiptFilterCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateReceiptFilterCommandInput): import("@smithy/core/client").CommandImpl<CreateReceiptFilterCommandInput, CreateReceiptFilterCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
