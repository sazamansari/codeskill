...
declare const DeleteReceiptRuleCommand_base: {
    new (input: DeleteReceiptRuleCommandInput): import("@smithy/core/client").CommandImpl<DeleteReceiptRuleCommandInput, DeleteReceiptRuleCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteReceiptRuleCommandInput): import("@smithy/core/client").CommandImpl<DeleteReceiptRuleCommandInput, DeleteReceiptRuleCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
