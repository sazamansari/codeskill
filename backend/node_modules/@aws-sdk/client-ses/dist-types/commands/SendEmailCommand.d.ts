...
declare const SendEmailCommand_base: {
    new (input: SendEmailCommandInput): import("@smithy/core/client").CommandImpl<SendEmailCommandInput, SendEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendEmailCommandInput): import("@smithy/core/client").CommandImpl<SendEmailCommandInput, SendEmailCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
