...
declare const ListIdentityPoliciesCommand_base: {
    new (input: ListIdentityPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListIdentityPoliciesCommandInput, ListIdentityPoliciesCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListIdentityPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListIdentityPoliciesCommandInput, ListIdentityPoliciesCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
