...
declare const ListVerifiedEmailAddressesCommand_base: {
    new (input: ListVerifiedEmailAddressesCommandInput): import("@smithy/core/client").CommandImpl<ListVerifiedEmailAddressesCommandInput, ListVerifiedEmailAddressesCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListVerifiedEmailAddressesCommandInput]): import("@smithy/core/client").CommandImpl<ListVerifiedEmailAddressesCommandInput, ListVerifiedEmailAddressesCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
