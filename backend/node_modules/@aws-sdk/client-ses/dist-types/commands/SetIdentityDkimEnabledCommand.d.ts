...
declare const SetIdentityDkimEnabledCommand_base: {
    new (input: SetIdentityDkimEnabledCommandInput): import("@smithy/core/client").CommandImpl<SetIdentityDkimEnabledCommandInput, SetIdentityDkimEnabledCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetIdentityDkimEnabledCommandInput): import("@smithy/core/client").CommandImpl<SetIdentityDkimEnabledCommandInput, SetIdentityDkimEnabledCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
