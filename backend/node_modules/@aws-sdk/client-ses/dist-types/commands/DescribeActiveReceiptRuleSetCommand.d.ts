...
declare const DescribeActiveReceiptRuleSetCommand_base: {
    new (input: DescribeActiveReceiptRuleSetCommandInput): import("@smithy/core/client").CommandImpl<DescribeActiveReceiptRuleSetCommandInput, DescribeActiveReceiptRuleSetCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeActiveReceiptRuleSetCommandInput]): import("@smithy/core/client").CommandImpl<DescribeActiveReceiptRuleSetCommandInput, DescribeActiveReceiptRuleSetCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
