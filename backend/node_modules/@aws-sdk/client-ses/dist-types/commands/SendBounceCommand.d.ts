...
declare const SendBounceCommand_base: {
    new (input: SendBounceCommandInput): import("@smithy/core/client").CommandImpl<SendBounceCommandInput, SendBounceCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendBounceCommandInput): import("@smithy/core/client").CommandImpl<SendBounceCommandInput, SendBounceCommandOutput, import("..").SESClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
