      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 relative bg-white dark:bg-zinc-950">
        ...
        <div className="w-full max-w-[420px] flex flex-col gap-6">
          ...
          <div className="mb-4 text-center">
            ...
            <h3 className="text-xl font-medium text-muted-foreground">Login to your account</h3>
            <p className="text-sm text-muted-foreground mt-4">It's nice to see you again. Ready to code?</p>
          </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              disabled={isLoading}
              type="submit"
              className="w-full h-12 rounded-md bg-zinc-900 dark:bg-white hover:bg-zinc-800 dark:hover:bg-zinc-200 text-white dark:text-black font-semibold text-sm transition-all flex items-center justify-center disabled:opacity-70 shadow-md"
            >
              {isLoading ? (
          ...
          <div className="text-center mt-6">
            <Link href="/admin/login" className="text-xs font-medium text-muted-foreground hover:text-foreground transition-colors inline-flex items-center justify-center gap-1">
              Admin Access
            </Link>
          </div>
        </div>
