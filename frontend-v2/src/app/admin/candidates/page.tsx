export default function PlaceholderPage() {
  return (
    <div className="p-8 font-sans max-w-7xl mx-auto h-full flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Candidates (Coming Soon)</h1>
      <p className="text-gray-500 max-w-md">
        View and manage candidates, student profiles, and assessment reports. This feature is scheduled to be built in an upcoming development phase.
      </p>
    </div>
  );
}
